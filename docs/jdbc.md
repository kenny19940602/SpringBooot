...
SpringBoot底层都是采用SpringData的方式进行统一各种数据库，SpringData也是Spring中与SpringBoot、SpringCloud等齐名的知名项目。
...
>测试
>
编写一个Controller，注入jdbcTempalte,编写测试进行访问测试；
